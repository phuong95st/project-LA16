...
<script type="text/javascript" src="${url }/js/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>  -->

<link href="${url }/css/bootstrap-datepicker.min.css" rel="stylesheet" media="screen">
<script type="text/javascript" src="${url }/js/bootstrap-datepicker.min.js" charset="UTF-8"></script>
<script type="text/javascript" src="${url }/js/bootstrap-datepicker.vi.js" charset="UTF-8"></script>
