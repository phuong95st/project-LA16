		...
		<div class="container text-center">
			<div class="row content" id="content">
				...
				<div class="col-sm-10 text-left" id="all_content">
											...
											<tr>
												...
												<c:choose>
													...
													<c:when test="${onl.late}">
														<td class="text-danger small"><img alt="Loading" src="${url }/images/loader.gif" id="loader10" class="hidden" width="10pt" height="10pt"> Bạn đã giao ban muộn <b>${onl.lateMin}</b> phút
														<c:choose>
															<c:when test="${onl.reason == null || onl.reason == '' }">
																<div>
																	<p class="col-sm-9">
																		<input type="text" placeholder="Nhập lý do ..."
																			class="form-control" name="reasonOnl">
																	</p>
																	<button class="btn btn-warning" onclick="javascript: clickReason(${onl.id});">
													...
													<c:otherwise>
														...
														id="loader9" class="hidden">
														<button class="btn btn-info btn-xs" onclick="javascript:clickGiaoBan(${onl.id});">Nhận giao ban</button></td>
													</c:otherwise>
												</c:choose>
											</tr>
					...
					<div class="col-sm-3">
						<script src="http://www.clocklink.com/embed.js"></script> <script type="text/javascript" language="JavaScript">obj=new Object;obj.clockfile="0054-brown.swf";obj.TimeZone="GMT0700"; obj.width=180;obj.height=180;obj.wmode="transparent";showClock(obj);</script>
					</div>
								...
								<table class="table table-condensed">
									...
									<c:forEach items="${lisScheStus}" var="scheStu">
										<tr>
											...
											<td><a class="btn btn-success btn-xs" href="student_detail.htm?action=view&scheStuId=${scheStu.id }">Chi tiết</a></td>
										</tr>
										<c:set var="no" value="${no + 1}"></c:set>
									</c:forEach>
